<%@ page contentType="text/html;charset=UTF-8" %>
    ...
    <% String error=(String) request.getAttribute("error"); String message=(String) request.getAttribute("message"); %>
        <div class="app-card"
            style="background: rgba(255,255,255,0.98); padding: 2.5rem; border-radius: 16px; box-shadow: 0 30px 80px rgba(0,0,0,0.25); width: 100%; max-width: 420px;">

            <div class="app-logo-ring"
                style="position: relative; width: 70px; height: 70px; margin-inline: auto; margin-bottom: 2rem; display: flex; align-items: center; justify-content: center; border-radius: 50%; background: linear-gradient(135deg, rgba(10,157,192,0.12), rgba(0,78,110,0.08)); border: 1px solid rgba(10,157,192,0.22);">
        ...
        color: #002B3E; letter-spacing: -0.5px;">Welcome</h1>
            ...
            <% if (error !=null) { %>
                <div class="app-alert--error"
                    style="background: #FFE5E5; border-left: 4px solid #C03929; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; color: #7A1E15; font-size: 13px; text-align: center;">
                ...
                <% } %>
                    ...
                    <% if (message !=null) { %>
                        <div
                            style="background: #E8F7EE; border-left: 4px solid #2E8B57; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; color: #1B5E20; font-size: 13px; text-align: center;">
                            <i class="bi bi-check-circle"></i>
                            <%= message %>
                        </div>
                        <% } %>

                            <form id="app-login-form" method="post" action="<%= request.getContextPath() %>/login"
                                novalidate>
                                <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}" />

                                <div class="app-field mb-4" style="position: relative;">
                                    <label class="app-label"
                                        style="display: block; font-weight: 500; color: #004E6E; font-size: 13px; margin-bottom: 8px; letter-spacing: 0.3px;">Username</label>
                                    <input type="text" name="username" id="app-username" class="app-input form-control"
                                ...
                                <div class="app-field mb-3" style="position: relative;">
                                    <label class="app-label"
                                        style="display: block; font-weight: 500; color: #004E6E; font-size: 13px; margin-bottom: 8px; letter-spacing: 0.3px;">Password</label>
                                    <div style="position: relative;">
                                        <input type="password" name="password" id="app-password"
                                        ...
                                        <button type="button" class="auth-eye" data-target="app-password"
                                ...
                                <div class="app-field mb-4" style="text-align: center;">
                                    <a href="<%= request.getContextPath() %>/forgot-password"
                                        style="color: #004E6E; font-size: 13px; text-decoration: underline;">Forgot
                                        Password?</a>
                                </div>

                                <button type="submit" class="app-submit btn w-100"
                            ...
                            <%-- <p class="text-center mt-4" style="font-size: 13px; color: #004E6E;">--%>
                                <%-- Don't have an account?--%>
                                    <%-- <a href="<%= request.getContextPath() %>/register"
                                        style="color: #0A9DC0; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">Sign
                                        up here</a>--%>
                                        <%-- </p> --%>
