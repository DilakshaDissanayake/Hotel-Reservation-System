            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <% User headerUser=(User) session.getAttribute("authUser"); if (headerUser !=null && "ADMIN"
                            .equals(headerUser.getRole())) { %>
                            <li class="nav-item">
                                <a class="nav-link app-link" href="<%= request.getContextPath() %>/staff">Staff</a>
                            </li>
                            <% } %>
                                <li class="nav-item">
                                    <a class="nav-link app-link" href="#" data-bs-toggle="modal"
                    ...
                    <ul class="navbar-nav ms-auto">
                        <% Object authUser=session.getAttribute("authUser"); if (authUser !=null) { %>
                            ...
                            <li class="nav-item">
                                <a class="btn app-btn-logout btn-sm ms-lg-2"
