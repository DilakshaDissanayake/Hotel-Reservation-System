    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link app-link" href="<%= request.getContextPath() %>/">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link app-link" href="<%= request.getContextPath() %>/rooms">Rooms</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link app-link" href="<%= request.getContextPath() %>/reservations">My Reservations</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link app-link" href="<%= request.getContextPath() %>/contact">Contact</a>
                </li>
            </ul>
